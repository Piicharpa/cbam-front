...
const Formdev: React.FC = () => {
  ...
  const getCurrentRef = () => {
    switch (activeStep) {
      case 0:
        return SumupFormRef;
      case 1:
        return installationFormRef;
      case 2:
        return verifierFormRef;
      case 3:
        return goodsFormRef;
      case 4:
        return precursorsFormRef;
      case 5:
        return amountFormRef;
      case 6:
        return sourceFormRef;
      default:
        return null;
    }
  };
  ...
  const renderStepContent = (step: number) => {
    switch (step) {
      case 0:
        return <SumupForm onNextStep={handleNext} />;
      case 1:
        return (
          <InstallationForm
          ...
          <Box sx={{ minHeight: "450px", position: "relative" }}>
            ...
            <Box
              sx={{
                ...
                borderRadius: "50%",
                background:
                  "radial-gradient(circle, rgba(231,249,205,0.5) 0%, rgba(243,247,231,0) 70%)",
                zIndex: 0,
              }}
            />
