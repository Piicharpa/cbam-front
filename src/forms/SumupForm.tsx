            ...
            >
              ...
              >
                ...
                {/* <div
                  style={{
                    padding: "1rem",
                    backgroundColor: isEditMode ? "#fff3e0" : "#e8f5e8",
                    borderRadius: "8px",
                    border: `1px solid ${isEditMode ? "#ffcc02" : "#4caf50"}`,
                  }}
                >
                  ...
                  <div style={{ fontSize: "0.9rem" }}>
                    {isEditMode ? (
                      <>
                        <div>Report ID: <strong>{currentReportId}</strong></div>
                        {existingReportData && (
                          <>
                            <div>Created: {new Date(existingReportData.created_at).toLocaleDateString()}</div>
                            <div>Last Updated: {new Date(existingReportData.updated_at).toLocaleDateString()}</div>
                          </>
                        )}
                      </>
                    ) : (
                      "Creating a new CBAM report"
                    )}
                  </div>
                </div> */}
                  ...
                  >
                    ...
                    <pre style={{ margin: "0.5rem 0 0 0" }}>
                      {JSON.stringify({
                        ...
                        isEditMode,
                        formValues,
                        hasExistingData: !!existingReportData,
                      }, null, 2)}
                    </pre>
                  </div>
                )} */}
